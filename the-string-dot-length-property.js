...
// Your code here
console.log("Coding Bootcamp = " + lengthOne + " characters"); // Characters in stringOne
console.log("JavaScript = " + lengthTwo + " characters"); // Characters in stringTwo
console.log("" + lengthThree + " characters"); // Characters in stringThree
